...
const LinkButton: React.FC<LinkButtonProps> = ({ href, text }) => {
  ...
  return (
    <button className="hover__button px-4 mt-4 py-2 bg-[#1F6752] rounded-lg text-[#fafafa] flex justify-around gap-2
    items-center"
    ...
    onMouseLeave={handleMouseLeave}>
      ...
      >
        <circle cx="11" cy="11" r="10.5" className="stroke-[#fafafa]" />
        <path
